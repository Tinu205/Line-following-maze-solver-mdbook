...
Not a remote-controlled car but a bot that looks at a black line on the floor with its own sensors, works out where the line went, and steers to stay on it. By the last task it will find its way through a maze, and then you will race it.
